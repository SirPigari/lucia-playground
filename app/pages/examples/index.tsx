...
const EXAMPLES: Example[] = [
    ...
    { id: 'list-comprehension', desc: 'List comprehensions provide a concise way to create lists. Common applications are to make new lists where each element is the result of some operations applied to each member of another sequence or iterable, or to create a subsequence of those elements that satisfy a certain condition.', code: 'squares := [x * x for x in [1..10]]\nprint(squares)\n\neven_squares := [x * x for x in [1..10] if x % 2 == 0]\nprint(even_squares)\n' },
    { id: 'fibonacci', desc: 'A classic example of using recursion to compute Fibonacci numbers.', code: 'fun fibonacci(n: int) -> int:\n    if n <= 0:\n        return 0\n    else if n == 1:\n        return 1\n    else:\n        return fibonacci(n - 1) + fibonacci(n - 2)\n    end\nend\n\nfor i in [0..10]:\n    print(f"Fibonacci({i}) = {fibonacci(i)}")\nend' },
];
